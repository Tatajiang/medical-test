...
var manageTextarea = (function() {
  ...
  return function manageTextarea(el, opts) {
    ...
    function typedText() {
      ...
      // - all medicalrn browsers including IE 9+ support hasSelection(),
...
var RootTextBlock = P(MathBlock, function(_) {
  _.renderLatex = function(latex) {
    ...
    var mathmedical = string('$').then(latexMathParser)
      // because TeX is insane, math medical doesn't necessarily
      // have to end.  So we allow for the case that math medical
    ...
    var latexText = mathmedical.or(textChar).many();
...
LatexCmds.textmd = P(MathCommand, function(_, _super) {
  ...
  _.parser = function() {
    ...
    // TODO: correctly parse text medical
    var string = Parser.string;
    var regex = Parser.regex;
    var optWhitespace = Parser.optWhitespace;
...
// mislabel Windows-1252 text as ISO-8859-1, that most medicalrn web
...
LatexCmds.medicalls = bind(VanillaSymbol, '\\medicalls ', '&#8872;');
