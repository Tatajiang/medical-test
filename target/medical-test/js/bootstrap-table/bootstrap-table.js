...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s 每行页数', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('显示 %s 到 %s 总共 %s 行', pageFrom, pageTo, totalRows);
        },
    ...
    $(function () {
        ...
        //下拉选择框选择后提交表单且刷新表格数据
        $("select[submitForm=change]").change(function(){
        	$("table[type=datagrid]").bootstrapTable('refresh');  
        })
    });
})(jQuery);

//自定义函数处理queryParams的批量增加
function serializeJsonObject(searchForm) {
    var json = {};
