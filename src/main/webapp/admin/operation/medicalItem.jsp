            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form" id="editForm" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="medicalName" class="form-control" trueName data-trueName="trueName" data-bv-notempty-message="项目名称不能为空" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="number" name="ageMin" class="form-control"  />
                        </div>
                        <span class="col-sm-2" style="text-align: center">—————</span>
                        <div class="col-sm-4">
                            <input type="number" name="ageMax" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
            ...
            if(row == ""){
                ...
                Modal.confirm({ message: "确定要删除吗?(注意：删除该项目后，预约过该项目的用户依旧可以查看该项目信息!)",icon:"fa fa-exclamation-circle"}).on(function (e) {
                    if (e) {
                        ...
                        $.ajax({
                            url:$ctx+ '/service/rest/platform.operation.MedicalItemService/collection/deletes?ids='+array,
        ...
        $('#dataList').bootstrapTable({
            ...
            uniqueId:'id',	// 指定主键列
            method:'post',
            url: $ctx + '/service/rest/platform.operation.MedicalItemService/collection/query',
            striped: true,
            pagination: true,
            pageNumber: 1,
            pageSize: 10,
            ...
            columns : [
                ...
                {field : "medicalName" ,title : "项目名称" ,align:"center" ,width : 80},
        ...
        if(bootstrapValidator.isValid()){
            Modal.confirm({ message: "确定保存?",icon:"fa fa-exclamation-circle"}).on(function (r) {
                if(r){
                    ...
                    if(!params.id){
                        var url = $ctx + '/service/rest/platform.operation.MedicalItemService/collection/create';
                    }else{
                        var url = $ctx + '/service/rest/platform.operation.MedicalItemService/collection/update';
                    }
