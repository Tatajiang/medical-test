...
(function ($) {
    if($.fn.ajaxForm == undefined) {
        $.getScript($ctx + "/js/jquery-upload-file-master/js/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>支持批量上传</b></span>",
            uploadStr:"上传",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deleteStr: "删除",
            ...
            if($.fn.ajaxForm) {
                ...
                $(obj).append(obj.errorLog);
   				...
   				if(s.showQueueDiv)
		            ...
		            obj.container = $("<div class='ajax-file-upload-container'  id='statusbar'></div>").insertAfter($(obj));
	...
	this.enqueueFile = function(file){
		...
		function defaultProgressBar(obj,s)
		{
			...
			this.statusbar = $("<div class='ajax-file-upload-statusbar'></div>").width(500);
