...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshmedical) {
        ...
        _initTemplateDefaults: function () {
            ...
            tModalMain = '<div id="' + $h.MODAL_ID + '" class="file-zoom-dialog modal fade" ' +
                'tabindex="-1" aria-labelledby="' + $h.MODAL_ID + 'Label" data-backdrop="false"></div>';
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileName: '文件 "{name}" 名中无效或不支持的字符.',
        msgInvalidFileType: '文件 "{name}" 类型无效. 只支持 "{types}" 文件.',
        msgInvalidFileExtension: '文件 "{name}" 扩展名无效. 只支持 "{extensions}" 文件.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadBegin: '初始化中...',
        msgUploadEnd: '上传成功',
        msgUploadEmpty: '没有可用的数据上传.',
        msgUploadError: '上传错误',
        msgValidationError: '验证错误',
        msgLoading: '加载文件 {index} of {files} &hellip;',
        msgProgress: '加载文件 {index} of {files} - {name} - {percent}% completed.',
        msgSelected: '{n} {files} selected',
        msgFoldersNotAllowed: 'Drag & drop files only! {n} folder(s) dropped were skipped.',
        msgImageWidthSmall: '图像 "{name}" 文件宽度 必须至少 {size} px.',
        msgImageHeightSmall: '图像 "{name}" 文件高度 必须至少 {size} px.',
        msgImageWidthLarge: '图像 "{name}" 文件宽度 不能超过 {size} px.',
        msgImageHeightLarge: '图像 "{name}" 文件高度 不能超过 {size} px.',
        msgImageResizeError: '无法使图像尺寸调整.',
        msgImageResizeException: '调整图像大小时出错.<pre>{errors}</pre>',
        msgAjaxError: '{operation} 操作出了问题。请稍后再试 !',
        ...
        dropZoneClickTitle: '<br>(单击选择 {files})',
...
function fishFileInput(fileId, uploadUrl,type){
	fileId.fileinput({
		'theme': 'explorer-fa',
        language: 'zh', //设置语言
