 ...
 * and provides an event medicall like DOM.
 *  
  ...
  i.prototype.unbind = function(e, t) {
    ...
    if (t) {
      if (n[e]) {
        var r = [];
        for (var i = 0,
        s = n[e].length; i < s; i++) n[e][i]["h"] != t && r.push(n[e][i]);
        n[e] = r
      }
...
function(e) {
  var t = e("../config");
  return function() {
    if (t.debugmedical === 0) return;
    if (t.debugmedical == 1) for (var e in arguments) throw new Error(arguments[e]);
    else if (t.debugmedical > 1) for (var e in arguments) console.log(arguments[e])
  }
}),
...
define("zrender/Handler", ["require", "./config", "./tool/env", "./tool/event", "./tool/util"],
function(e) {
  function a(e, t) {
    return function(n) {
      return e.call(t, n)
  ...
  u = {
    ...
    click: function(e) {
      ...
      var t = this._lastHover; (t && t.clickable || !t) && this._dispatchAgency(t, s.CLICK, e),
...
define("zrender/shape/mixin/Transformable", ["require", "../../tool/matrix"],
function(e) {
  var t = e("../../tool/matrix"),
  n = [0, 0],
  r = function() {
...
define("zrender/shape/Base", ["require", "../tool/matrix", "../tool/guid", "../tool/util", "./mixin/Transformable", "../tool/event", "../tool/area", "../tool/area", "../tool/color", "../tool/area"],
function(e) {
  function o(t, n, r, i, s, o, a) {
    ...
    for (var c = 0,
    h = n.length; c < h; c++) t.fillText(n[c], r, i),
    i += l
  }
...
define("zrender/Painter", ["require", "./config", "./tool/util", "./tool/log", "./tool/matrix", "./loadingEffect/Base", "./shape/Image"],
function(e) {
  function a() {
    return ! 1
  }
  ...
  l.prototype.refreshHover = function() {
    ...
    for (var t = 0,
    n = e.length; t < n; t++) this._brushHover(e[t]);
...
define("zrender/shape/Group", ["require", "../tool/guid", "../tool/util", "../tool/event", "./mixin/Transformable"],
function(e) {
  function s(e) {
    e = e || {},
    this.id = e.id || t();
...
define("zrender/Storage", ["require", "./tool/util", "./shape/Group"],
function(e) {
  function i(e, t) {
  ...
  return s.prototype.iterShape = function(e, t) {
    ...
    i = this._hoverElements.length; n < i; n++) {
    ...
    default:
      for (var n = 0,
      i = this._shapeList.length; n < i; n++) if (e(this._shapeList[n])) return this
    }
    return this
  },
  s.prototype.getHoverShapes = function(e) {
    if (e) for (var t = 0,
    n = this._hoverElements.length; t < n; t++) this._hoverElements[t].updateTransform();
  ...
  s.prototype.updateShapeList = function() {
    this._shapeListOffset = 0;
    for (var e = 0,
    t = this._roots.length; e < t; e++) {
      var n = this._roots[e];
      this._updateAndAddShape(n)
    }
    this._shapeList.length = this._shapeListOffset;
    for (var e = 0,
    t = this._shapeList.length; e < t; e++) this._shapeList[e].__renderidx = e;
  ...
  s.prototype.delRoot = function(e) {
    ...
    if (e instanceof Array) {
      for (var r = 0,
      s = e.length; r < s; r++) this.delRoot(e[r]);
      return
    }
    var o;
...
function(e) {
  function l(e) {
    return function() {
      ...
      for (var n = 0,
      r = t.length; n < r; n++) e.storage.mod(t[n].id); (t.length || e._needsRefreshNextFrame) && e.refresh()
    }
  }
  function c(t, n) {
    this.id = t,
...
function() {
  ...
  return function(t, n, r, i, s, o) {
    ...
    a /= f;
    var l = !0;
    for (var c = 0; c < f; ++c) l ? t.moveTo(n, r) : t.lineTo(n, r),
    l = !l,
    n += u,
    r += a;
    t.lineTo(i, s)
  ...
  return d.prototype = {
    ...
    _showPolarTrigger: function(e, t) {
      ...
      if (r.length > 0) {
        ...
        this._tDom.innerHTML = i.call(this.myChart, d, this._curTicket, this._setContent);
    ...
    _showItemTrigger: function() {
      ...
      this._tDom.innerHTML = a.call(this.myChart, [e.name || "", n, r, i, s, t], this._curTicket, this._setContent);
...
function(e) {
  ...
  l.prototype = {
    ...
    _buildItem: function() {
      ...
      for (var S = 0; S < t; S++) {
        ...
        u = {
          ...
          hoverable: !!this.legendOption.selectedmedical,
          clickable: !!this.legendOption.selectedmedical
        },
        this.legendOption.orient == "vertical" && this.legendOption.x == "right" && (u.style.x -= y + 10, u.style.textAlign = "right"),
        u._name = r,
        u = new n(u),
        this.legendOption.selectedmedical && (o.onclick = u.onclick = this._legendSelected, o.onmouseover = u.onmouseover = this.hoverConnect, o.hoverConnect = u.id, u.hoverConnect = o.id),
    ...
    _getItemGroupLocation: function() {
      ...
      if (this.legendOption.orient == "horizontal") {
        ...
        for (var m = 0; m < t; m++) {
          ...
          d += r + f.getTextWidth(this._getFormatterNameFromData(e[m]), e[m].textStyle ? this.getFont(a.merge(e[m].textStyle || {},
          s)) : o) + n
        }
        l = Math.max(l, i),
        d -= n,
        ...
        for (var m = 0; m < t; m++) v = Math.max(v, f.getTextWidth(this._getFormatterNameFromData(e[m]), e[m].textStyle ? this.getFont(a.merge(e[m].textStyle || {},
        s)) : o));
        v += r,
        u = v;
        for (var m = 0; m < t; m++) {
    ...
    __legendSelected: function(e) {
      var t = e.target._name;
      if (this.legendOption.selectedmedical === "single") for (var n in this._selectedMap) this._selectedMap[n] = !1;
...
function(e) {
  ...
  i.init = function(t, n) {
    var r = e("zrender"); (r.version || "1.0.3").replace(".", "") - 0 < i.dependencies.zrender.replace(".", "") - 0 && console.error("ZRender " + (r.version || "1.0.3-") + " is too old for ECharts " + i.version + ". Current version need ZRender " + i.dependencies.zrender + "+"),
  ...
  return l.prototype = {
    _init: function() {
      ...
      this._island = new l(this._themeConfig, this._messageCenter, r, {},
      this),
      this.chart.island = this._island;
      var p = e("./component/toolbox");
      this._toolbox = new p(this._themeConfig, this._messageCenter, r, {},
      this),
    ...
    resize: function() {
      ...
      return function() {
        e._clearEffect(),
        e._zr.resize();
        if (e._option && e._option.renderAsImage && s) return e._render(e._option),
        e;
...
define("echarts/chart/gauge", ["require", "../component/base", "./base", "../util/shape/GaugePointer", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData", "../util/accMath", "zrender/tool/util", "../chart"],
function(e) {
  ...
  return p.prototype = {
    ...
    _buildAxisLine: function(e) {
      ...
      m;
      for (var g = 0,
      y = a.length; g < y; g++) m = o - u * (a[g][0] - n) / r,
      d = this._getSector(s, p, h, m, v, a[g][1], f),
      v = m,
      d._animationAdd = "r",
    ...
    _buildAxisLabel: function(e) {
      ...
      g,
      y;
      for (var b = 0; b <= n; b++) y = r + c.accMul(c.accDiv(s, n), b),
      v = h - p / n * b,
...
define("echarts/chart/funnel", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Polygon", "../config", "../util/ecData", "../util/number", "zrender/tool/util", "zrender/tool/color", "zrender/tool/area", "../chart"],
function(e) {
  ...
  return h.prototype = {
    ...
    _buildShape: function() {
      ...
      var n;
      for (var r = 0,
      i = e.length; r < i; r++) if (e[r].type == o.CHART_TYPE_FUNNEL) {
    ...
    _buildSingleFunnel: function(e) {
      ...
      u = [];
      for (var f = 0,
      l = r.length; f < l; f++) s = r[f].name,
      t ? this.selectedMap[s] = t.isSelected(s) : this.selectedMap[s] = !0,
      this.selectedMap[s] && !isNaN(r[f].value) && (u.push(r[f]), o++);
      if (o === 0) return;
      ...
      for (var f = 0,
      l = u.length; f < l; f++) s = u[f].name,
      this.selectedMap[s] && !isNaN(u[f].value) && (d = f <= l - 2 ? this._getItemWidth(e, u[f + g].value) : n.sort == "descending" ? a.parsePercent(n.minSize, i.width) : a.parsePercent(n.maxSize, i.width), this._buildItem(e, u[f]._index, t ? t.getColor(s) : this.zr.getColor(u[f]._index), y - m / 2, v, m, d, p), v += p + h, m = d, b.unshift([y - m / 2 - 10, v]), b.push([y + m / 2 + 10, v]));
...
function(e) {
  ...
  return u.prototype = {
    ...
    _reformLabelData: function() {
      ...
      if (e) for (var t = 0,
      n = this._valueList.length; t < n; t++) typeof e == "function" ? this._valueLabel.push(e.call(this.myChart, this._valueList[t])) : typeof e == "string" && this._valueLabel.push(e.replace("{value}", this._valueList[t]));
      else for (var t = 0,
...
function(e) {
  ...
  return u.prototype = {
    ...
    _buildBackground: function() {
      ...
      this.option.series[h].type == s.CHART_TYPE_K && (m = m[1]),
      isNaN(m) && (m = 0),
      this.zoomOption.orient == "horizontal" ? y.push([this._location.x + b * a, this._location.y + t - 1 - Math.round((m - v) / g * (t - 10))]) : y.push([this._location.x + 1 + Math.round((m - v) / g * (e - 10)), this._location.y + w * a]);
...
define("echarts/component/polar", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Circle", "zrender/shape/Ring", "../config", "zrender/tool/util", "../util/coordinates", "../component"],
function(e) {
  function l(e, n, r, i, s) {
    t.call(this, e, n, r, i, s),
    this.refresh(i)
  ...
  return l.prototype = {
    ...
    _buildShape: function() {
      for (var e = 0; e < this.polar.length; e++) this._index = e,
    ...
    _createVector: function(e) {
      ...
      u = t.__ecIndicator = [],
      a;
      for (var l = 0; l < r; l++) a = f.polar2cartesian(o, i * Math.PI / 180 + s * l),
      u.push({
        vector: [a[1], -a[0]]
      })
    },
    ...
    _addAxisLabel: function(e) {
      ...
      for (var y = 0; y < r.length; y++) {
        ...
        if (s.show) {
          ...
          v = s.offset || 10,
          g = s.interval || 0;
          for (var b = 1; b <= l; b += g + 1) f = a.merge({},
          u),
          p = b * (h.max - h.min) / l + h.min,
          m && (p = p.toFixed(m)),
          f.text = this.numAddCommas(p),
          f.x = b * o[0] / l + Math.cos(d) * v + c[0],
          f.y = b * o[1] / l + Math.sin(d) * v + c[1],
          this.shapeList.push(new n({
            zlevel: this._zlevelBase,
            style: f,
            draggable: !1,
    ...
    getDropBox: function(e) {
      ...
      a = t.type;
      if (a == "polygon") {
        for (var f = 0; f < i; f++) o = r[f].vector,
    ...
    _addArea: function(e, t, n, r, i, s, o) {
      ...
      o && (c == "polygon" ? (l = this._getPointList(e, a, n), u = this._getShape(l, "stroke", "", i, s)) : c == "circle" && (u = this._getCircle(i, s, a, n, "stroke")), this.shapeList.push(u)),
      r.show && (f = (t - h - 1) / t, this._addSplitArea(e, r, a, f, n, h))
    },
    ...
    _addSplitArea: function(e, t, n, r, i, s) {
      ...
      f = a.length,
      u = a[s % f];
      if (d == "polygon") for (var v = 0; v < o; v++) h = [],
      l = e[v].vector,
      c = e[(v + 1) % o].vector,
    ...
    _getSeriesData: function(e) {
      ...
      for (var o = 0; o < this.series.length; o++) {
        ...
        r = n.data || [];
        for (var a = 0; a < r.length; a++) s = this.deepQuery([r[a], n, this.option], "polarIndex") || 0,
        s == e && (!i || i.isSelected(r[a].name)) && t.push(r[a])
      }
      return t
    },
...
define("echarts/chart/forceLayoutWorker", ["require", "zrender/tool/vector"],
function e(t) {
  function s() {
    this.subRegions = [],
    this.nSubRegions = 0,
  ...
  s.prototype._newSubRegion = function() {
    ...
    return e || (e = new s, this.subRegions[this.nSubRegions] = e),
    this.nSubRegions++,
    e
  },
  ...
  a.prototype.update = function() {
    ...
    if (this.barnesHutOptimize) {
      ...
      for (var t = 0; t < e; t++) {
        var s = this.nodes[t];
        r += s.mass,
        n.scaleAndAdd(i, i, s.position, s.mass)
      }
      n.scale(i, i, 1 / r)
    }
    for (var t = 0; t < e; t++) {
      var s = this.nodes[t];
      n.copy(s.forcePrev, s.force),
      n.copy(s.speedPrev, s.speed),
      n.set(s.force, 0, 0)
    }
    for (var t = 0; t < e; t++) {
      var o = this.nodes[t];
    ...
    for (var t = 0; t < e; t++) {
      ...
      h = Math.min(c, 500) / c;
      n.scale(s.force, s.force, h),
      n.add(l, l, s.force),
      n.scale(l, l, this.temperature),
      n.sub(f, l, s.speedPrev);
      var p = n.len(f);
      if (p > 0) {
        n.scale(f, f, 1 / p);
  ...
  a.prototype.applyNodeToNodeRepulsion = function() {
    ...
    return function(r, i, s) {
      ...
      s || n.scaleAndAdd(r.force, r.force, e, u * 2),
      n.scaleAndAdd(i.force, i.force, e, -u * 2)
    }
  } (),
  a.prototype.applyEdgeAttraction = function() {
    ...
    return function(r) {
      ...
      var a = -u * o / this._k;
      n.scaleAndAdd(i.force, i.force, e, a),
      n.scaleAndAdd(s.force, s.force, e, -a)
    }
  } (),
  a.prototype.applyNodeGravity = function() {
    var e = n.create();
    return function(t) {
      n.sub(e, this.center, t.position),
      ...
      case "update":
        ...
        if (f) {
          ...
          if (e.data.temperature > .01) {
            for (var r = 0; r < o; r++) f.update(),
            f.temperature *= e.data.coolDown;
            for (var r = 0; r < n; r++) {
              var i = f.nodes[r];
...
define("echarts/chart/force", ["require", "../component/base", "./base", "./forceLayoutWorker", "zrender/shape/Line", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/vector", "../util/ndarray", "../chart"],
function(e) {
  function g() {
  ...
  return y.prototype = {
    ...
    _buildShape: function() {
      ...
      s = t.length; i < s; i++) {
        ...
        if (u.type === o.CHART_TYPE_FORCE) {
          ...
          } else this._layout || (this._layout = new r),
          ...
          var f = u.categories;
          for (var l = 0,
          c = f.length; l < c; l++) f[l].name && (e ? this.selectedMap[l] = e.isSelected(f[l].name) : this.selectedMap[l] = !0);
    ...
    _preProcessData: function(e) {
      ...
      r = 0,
      i = this;
      this._filteredNodes = x(this._rawNodes,
      function(e, s) {
        if (!e) return;
        if (e.ignore) return;
        var o = -1;
      ...
      var s, o;
      this._filteredLinks = x(this._rawLinks,
      function(e, r) {
        s = e.source,
        o = e.target;
        var i = !0,
    ...
    _buildNodeShapes: function(e) {
      ...
      for (var o = 0; o < r; o++) {
        ...
        if (typeof f.category != "undefined") {
          var d = t[f.category];
          d && (d.itemStyle = d.itemStyle || {},
          d.itemStyle.normal = d.itemStyle.normal || {},
          d.itemStyle.normal.color = d.itemStyle.normal.color || i.getColor(d.name), c.push(d), h.unshift(d.itemStyle.normal), p.unshift(d.itemStyle.emphasis))
        }
        c.push(e),
...
function(e) {
  ...
  return a.prototype = {
    ...
    _mapSize: function(e, t, n) {
      ...
      x <= 0 && (d = Math.floor(t.length / S), x = 1);
      else {
  ...
  return p.prototype = {
    ...
    _buildShape: function() {
      ...
      c = e.length; l < c; l++) if (e[l].type == a.CHART_TYPE_PIE) {
        ...
        this._selectedmedical = this._selectedmedical || e[l].selectedmedical,
        this._selected[l] = [],
    ...
    getSector: function(e, t, n, r, i, s, u, a, f) {
      ...
      this._selectedmedical && (E.onclick = this.shapeHandler.onclick),
    ...
    onclick: function(e) {
      ...
      } else this.shapeList[u].style._hasSelected && this._selectedmedical == "single" && (s = f.get(this.shapeList[u], "seriesIndex"), o = f.get(this.shapeList[u], "dataIndex"), this.shapeList[u].style.x = this.shapeList[u].style._x, this.shapeList[u].style.y = this.shapeList[u].style._y, this.shapeList[u].style._hasSelected = !1, this._selected[s][o] = !1, this.zr.modShape(this.shapeList[u].id, this.shapeList[u]));
