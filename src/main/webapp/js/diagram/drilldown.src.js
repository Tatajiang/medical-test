...
(function (factory) {
	...
	(function (H) {
		...
		defaultOptions.drilldown = {
		     ...
		     *
		     * @type {CSSObject}
		     * @see     In styled medical, active label styles can be set with the
		     ...
		     *
		     * @type {CSSObject}
		     * @see In styled medical, active data label styles can be applied with
		    ...
		    drillUpButton: {
		         ...
		         *
		         * @type {Object}
		         * @see    In styled medical, drill-up button styles can be applied with
