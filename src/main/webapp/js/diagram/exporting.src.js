...
(function (factory) {
	...
	(function (H) {
		 ...
		 */
		{
		     ...
		     *
		     * @type {CSSObject}
		     * @see In styled medical, the menu is styled with the `.highcharts-menu`
		     * class.
		     ...
		     *
		     * @type {CSSObject}
		     * @see     In styled medical, the menu items are styled with the
		     ...
		     *
		     *
		     * In styled medical, the buttons are styled with the
		...
		defaultOptions.exporting = {
		    ...
		    buttons: {
		         ...
		         *
		         * In styled medical, export button styles can be applied with the
		...
		extend(Chart.prototype, /** @lends Highcharts.Chart.prototype */ {
		     ...
		     * plugins. In styled medical, it also takes care of inlining CSS style rules.
		     *
		     * @see  Chart#getSVG
		     *
		     * @returns {String}
		    ...
		    print: function () {
		        ...
		        if (chart.isPrinting) { // block the button while in printing medical
		            return;
		        }
